...
<html lang="en">
  ...
  <header role="banner" class="probootstrap-header">
    <div class="container">
        <a href="index_lc.php" class="probootstrap-logo">জানো ও জানাও</a>
        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            ...
            <li><a href="about_lc.php">Reports</a></li>
            <li><a href="contact_lc.php">Contact</a></li>
          </ul>
      ...
      <div class="row">
        ...
        <div class="col-md-3 probootstrap-sidebar">
          ...
          <ul class="stack-link">
            ...
            <li>More templates... <a href="https://uicookies.com">uiCookies</a></li>
          </ul>
        </div>
      </div>
    </div>
