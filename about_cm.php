    ...
    <div class="container">
        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            ...
            <li class="active"><a href="about_cm.php">Reports</a></li>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="slides-text probootstrap-animate" data-animate-effect="fadeIn">
                <h2>Stay updated about rural consumers!</h2>
                <p>Get reports from local sellers and keep records</p>
				<div class="col-md-12 text-center">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center section-heading probootstrap-animate" id="section2">
          <h2>Reports from Local Sellers</h2>
        </div>
      </div>
